...
/*   Updated: 2022/04/19 19:17:57 by lucferna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @brief Converts the numbers in string to integer; Numbers can be followed by
 a single '-' sign to make them negative.
 *
...
/*
 * @brief Converts the numbers in string to long; Numbers can be followed by
 a single '-' sign to make them negative.
 *
 * @param str The number in string format
 * @return The number as long type
 */
